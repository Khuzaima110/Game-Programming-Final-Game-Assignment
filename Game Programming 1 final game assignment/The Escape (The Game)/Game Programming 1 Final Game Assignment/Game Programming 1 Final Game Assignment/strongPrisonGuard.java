...
/**
 * Write a description of class strongPrisonGuard here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class strongPrisonGuard extends Actor
{
    private int dx=3;
    private int dy=3;
    /**
     * Act - do whatever the strongPrisonGuard wants to do. This method is called whenever
